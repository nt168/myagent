...
export default class RFB extends EventTargetMixin {
    constructor(target, urlOrChannel, options) {
        ...
        // Secure context check disabled for proxy mode
    ...
    _sendEncodings() {
        ...
        // In preference order
        // NOTE(CheckPilot): vendor/pako runtime sources are not bundled in this repo,
        // so zlib-based encodings (tight/zrle/zlib/jpeg/h264) are intentionally not
        // requested. This keeps compatibility with servers that support raw/hextile.
